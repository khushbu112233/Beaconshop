...
public class ElectClaimOfferAcivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    String offer_title, offer_desc, offer_id, quantity;
    ...
    private void connectWithHttpPost(final String quantity)
    {
        ...
        class HttpGetAsyncTask extends AsyncTask<String, Void, String> {
            ...
            //    System.out.println("paramUsername is :" + paramUsername + " paramPassword is :" + paramPassword);
                ...
                nameValuePair.add(new BasicNameValuePair("offer_id", offer_id));
                nameValuePair.add(new BasicNameValuePair("quantity", quantity));
                nameValuePair.add(new BasicNameValuePair("redeem", "1"));
        ...
        httpGetAsyncTask.execute(quantity);
