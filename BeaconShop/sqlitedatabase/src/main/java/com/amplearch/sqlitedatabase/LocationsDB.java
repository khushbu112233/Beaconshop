package com.amplearch.sqlitedatabase;
...
public class LocationsDB extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        String sql =     "create table " + DATABASE_TABLE + " ( " +
                ...
                FIELD_LNG + " double , " +
                FIELD_LAT + " double , " +
                FIELD_OFFER_TITLE + " text , " +
                FIELD_OFFER_DESC + " text , " +
    ...
    public Cursor getAllLocations(){
        return mDB.query(DATABASE_TABLE, new String[] { FIELD_ROW_ID,  FIELD_STORE_NAME, FIELD_LAT , FIELD_LNG,
                FIELD_OFFER_TITLE, FIELD_OFFER_DESC, FIELD_START_DATE, FIELD_END_DATE, FIELD_ZOOM } , null, null, null, null, null);
    }
